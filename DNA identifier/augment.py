"""
Real identification works on partial reads, so training samples are built the same way: random sliding-window fragments of the reference gene, with light pointmutations and random strand orientation to simulate sequencing noise.
"""
